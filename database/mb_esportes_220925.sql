...
--
-- Host: 127.0.0.1
-- Tempo de geração: 22/09/2025 às 23:45
...
INSERT INTO `produtos_tamanhos` (`id_produto`, `id_tamanho`) VALUES
(1, 1),
(1, 2),
(1, 3),
(1, 4);
...
ALTER TABLE `produtos_tamanhos`
  ...
  ADD KEY `idx_pt_tamanho` (`id_tamanho`);
...
--
-- Restrições para tabelas `produtos_tamanhos`
--
ALTER TABLE `produtos_tamanhos`
  ADD CONSTRAINT `fk_pt_produto` FOREIGN KEY (`id_produto`) REFERENCES `produtos` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `fk_pt_tamanho` FOREIGN KEY (`id_tamanho`) REFERENCES `tamanhos` (`id_tamanho`) ON DELETE CASCADE;
COMMIT;
